...
export default function DetailSasaranModal({ show = true, onHide, onClose, selectedSasaran, citizen, theme = null, themeColor = null, roleTitle = null, onEdit = null }) {
  ...
  const kategori = (target.kategori || "").trim();
  const katLower = kategori.toLowerCase();
  const isStatusActive = (target.status || "").toLowerCase() === "aktif";
              ...
              <div className="row g-3">
                ...
                <div className="col-12 col-md-6">
                  <div className="p-3 bg-light rounded-3 h-100">
                    ...
                    <div className="fw-bold text-dark">{target.gender || (isBumil || isNifas ? "Perempuan" : "-")}</div>
                  </div>
                </div>
                ...
                {target.golDarah && (
                  <div className="col-12 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                      ...
                      <div className="fw-bold text-dark">{target.golDarah}</div>
                    </div>
                  </div>
                )}
                ...
                <div className="col-12">
                  <div className="p-3 bg-light rounded-3 h-100">
                    ...
                    <div className="fw-bold text-dark">{target.alamat || ""}</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                      ...
                      <div className="fw-bold text-dark">{target.anakKe || target.ibuHamilDetail?.obstetri?.gravida || ""}</div>
                    </div>
                  </div>
                  <div className="col-12 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                ...
                <div className="row g-3">
                  <div className="col-12 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                      ...
                      <div className="fw-bold text-dark">{target.statusMenyusui || ""}</div>
                    </div>
                  </div>
                  <div className="col-12 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                ...
                <div className="row g-3">
                  <div className="col-12 col-sm-6 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                      ...
                      <div className="fs-5 fw-bold text-dark">{target.bbl ? (String(target.bbl).includes("kg") ? target.bbl : `${target.bbl} kg`) : target.bb ? `${target.bb} kg` : "-"}</div>
                    </div>
                  </div>
                  ...
                  <div className="col-12 col-sm-6 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                      ...
                      <div className="fs-5 fw-bold text-dark">{target.pbl ? (String(target.pbl).includes("cm") ? target.pbl : `${target.pbl} cm`) : target.tb ? `${target.tb} cm` : "-"}</div>
                    </div>
                  </div>
                ...
                <div className="row g-3">
                  <div className="col-12 col-md-6">
                    <div className="p-3 bg-light rounded-3 h-100">
                      ...
                      <div className="fw-bold text-dark">{Array.isArray(target.riwayatKeluarga) && target.riwayatKeluarga.length > 0 ? target.riwayatKeluarga.join(", ") : target.riwayatKeluarga || ""}</div>
                    </div>
                  </div>
                      ...
                      <div className="fw-bold text-dark">
                        {Array.isArray(target.riwayatDiriSendiri) && target.riwayatDiriSendiri.length > 0
                          ...
                          : Array.isArray(target.perilakuBerisikoUsekrem) && target.perilakuBerisikoUsekrem.length > 0
                            ...
                            : target.riwayatDiriSendiri || target.riwayatPenyakit || ""}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="p-3 bg-light rounded-3 h-100">
                        ...
                        <div className="d-flex flex-wrap gap-2">
                          <span className="badge bg-white text-dark border px-3 py-1.5 fw-medium">
                            Merokok:{" "}
                            <strong
                              className={typeof target.perilakuBerisikoDewasa === "object" && target.perilakuBerisikoDewasa?.merokok === "Ya" ? "text-danger" : target.perilakuBerisiko?.merokok === "Ya" ? "text-danger" : "text-success"}
                            >
                              {target.perilakuBerisikoDewasa?.merokok || target.perilakuBerisiko?.merokok || ""}
                            </strong>
                          </span>
                          <span className="badge bg-white text-dark border px-3 py-1.5 fw-medium">
                            Tinggi Gula:{" "}
                            <strong
                              className={
                                typeof target.perilakuBerisikoDewasa === "object" && target.perilakuBerisikoDewasa?.tinggiGula === "Ya" ? "text-danger" : target.perilakuBerisiko?.tinggiGula === "Ya" ? "text-danger" : "text-success"
                              }
                            >
                              {target.perilakuBerisikoDewasa?.tinggiGula || target.perilakuBerisiko?.tinggiGula || ""}
                            </strong>
                          </span>
                          <span className="badge bg-white text-dark border px-3 py-1.5 fw-medium">
                            Tinggi Garam:{" "}
                            <strong
                              className={
                                typeof target.perilakuBerisikoDewasa === "object" && target.perilakuBerisikoDewasa?.tinggiGaram === "Ya" ? "text-danger" : target.perilakuBerisiko?.tinggiGaram === "Ya" ? "text-danger" : "text-success"
                              }
                            >
                              {target.perilakuBerisikoDewasa?.tinggiGaram || target.perilakuBerisiko?.tinggiGaram || ""}
                            </strong>
                          </span>
                          <span className="badge bg-white text-dark border px-3 py-1.5 fw-medium">
                            Tinggi Lemak:{" "}
                            <strong
                              className={
                                typeof target.perilakuBerisikoDewasa === "object" && target.perilakuBerisikoDewasa?.tinggiLemak === "Ya" ? "text-danger" : target.perilakuBerisiko?.tinggiLemak === "Ya" ? "text-danger" : "text-success"
                              }
                            >
                              {target.perilakuBerisikoDewasa?.tinggiLemak || target.perilakuBerisiko?.tinggiLemak || ""}
                            </strong>
                          </span>
                        </div>
                      </div>
