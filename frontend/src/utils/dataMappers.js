...
export const FRONTEND_TO_BACKEND_KATEGORI = {
  'bumil': 'bumil',
  'busui': 'busui',
  'nifas': 'busui',
  'bayi-0-11': 'bayi',
  ...
  'remaja_awal': 'uskrem_6_14',
  'uskrem_6_14': 'uskrem_6_14',
  'usekrem-15-18': 'uskrem_15_18',
  'remaja_akhir': 'uskrem_15_18',
  'uskrem_15_18': 'uskrem_15_18',
  'dewasa': 'dewasa',
  'lansia': 'lansia'
};

export const mapFrontendCategoryToBackend = (category) =>
  FRONTEND_TO_BACKEND_KATEGORI[category] || category;
...
export function mapBackendWargaToFrontend(w) {
  ...
  return {
    ...
    statusPernikahan: w.status_perkawinan || w.status_pernikahan || w.statusPernikahan || 'Menikah',
