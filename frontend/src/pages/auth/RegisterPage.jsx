...
import { HeartHandshake, ArrowLeft, Loader2, AlertCircle, CheckCircle2, ShieldCheck, Mail, Lock, User, Phone, CreditCard, Building2, Clock, Inbox, Send, CheckCircle, FileText, Shield, Sparkles } from "lucide-react";
            ...
            {step === "form" ? (
             ...
             ========================================================================= */
              <div className="text-center py-2">
                ...
                <h2 className="fw-bold text-dark fs-4 mb-2">Menunggu Verifikasi</h2>
                ...
                <button type="button" className="btn btn-link text-decoration-none text-muted small p-0 mt-2" style={{ fontSize: "0.78rem" }} onClick={handleBackToLogin}></button>
              </div>
            )}
          </div>
        </div>
