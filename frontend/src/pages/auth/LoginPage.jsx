...
export default function LoginPage({ onLoginSuccess, onNavigateToRegister }) {
  ...
  return (
    <div className="min-vh-100 d-flex flex-column flex-lg-row bg-white">
      ...
      >
        ...
        <div className="my-auto py-4 z-1" style={{ maxWidth: "520px" }}>
          ...
          <h1 className="fw-bold text-white mb-3" style={{ fontSize: "2.5rem", lineHeight: "1.2", letterSpacing: "-0.03em" }}>
            Masa Depan Layanan Posyandu Terpadu
            <br />
            <span
              style={{
      ...
      <div className="col-12 col-lg-6 d-flex flex-column justify-content-between p-4 p-md-5" style={{ backgroundColor: "#ffffff", minHeight: "100vh" }}>
        {/* Top Header Bar */}
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-check mb-4 mt-2">
                <input className="form-check-input" type="checkbox" id="rememberMeCheck" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} disabled={isLoading} />
            ...
            <div className="text-center pt-2">
              <button type="button" className="btn btn-link p-0 text-decoration-none text-muted small" style={{ fontSize: "0.82rem" }} onClick={() => setShowRoleModal(true)}>
          ...
          <div className="modal-dialog modal-dialog-centered" style={{ maxWidth: "420px" }}>
            <div className="modal-content border-0 shadow-lg rounded-4 p-4 bg-white">
              <div className="d-flex align-items-center justify-content-between mb-3">
                <h5 className="fw-bold mb-0 text-dark">Panduan Masuk Sistem</h5>
              ...
              <div className="small text-secondary mb-4" style={{ lineHeight: "1.5" }}>
                <p className="mb-2">Gunakan email dan password akun yang sudah terdaftar pada backend.</p>
              ...
              <button type="button" className="btn btn-dark w-100 rounded-3 py-2 fw-semibold" onClick={() => setShowHelpModal(false)}>
                Tutup
              </button>
            </div>
          </div>
