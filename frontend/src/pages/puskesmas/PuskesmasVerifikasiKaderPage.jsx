        ...
        <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            >
              ...
              <span className={`badge rounded-pill ${activeTab === "pending" ? "bg-white text-dark" : "bg-secondary text-white"}`}>{currentPendingCount}</span>
            </button>

            <button
              className={`btn d-flex align-items-center gap-2 px-3 py-2 rounded-3 fw-bold transition-all ${activeTab === "active" ? "text-white shadow-sm" : "btn-light border text-secondary"}`}
                  ...
                  filteredKader.map((item, index) => (
                    <tr key={item.id}>
                      ...
                      <td>
                        ...
                        <div className="text-muted font-monospace small" style={{ fontSize: "0.75rem" }}>
                          {item.nik}
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        ...
                        {item.status === "active" && <span className="badge bg-success-subtle text-success border border-success px-2.5 py-1 fw-semibold small d-inline-flex align-items-center gap-1">Aktif</span>}
                        {(item.status === "rejected" || item.status === "inactive") && (
                          <span className="badge bg-danger-subtle text-danger border border-danger px-2.5 py-1 fw-semibold small d-inline-flex align-items-center gap-1">Ditolak</span>
                        )}
                      </td>
