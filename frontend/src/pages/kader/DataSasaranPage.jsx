...
import { kehamilanService } from "../../services";
...
export default function DataSasaranPage({
  ...
  const handleCategoryFormSubmit = async (e) => {
    ...
    if (rawPernikahan.includes("menikah") && !rawPernikahan.includes("belum") && !rawPernikahan.includes("tidak")) {
      ...
      statusPernikahanBackend = "menikah";
    } else if (rawPernikahan) {
      statusPernikahanBackend = "tidak_menikah";
    }

    if (!isFemale && !categoryForm.gender) {
    ...
    try {
      ...
      if ((katId === "bumil" || katId === "nifas") && err.message && err.message.toLowerCase().includes("sudah terdaftar")) {
        try {
          const listRes = await wargaService.getAllWarga({ search: nikValidation.cleanValue, status_domisili: "all" });
                          ...
                          <div className="pt-1">
                            ...
                            <div className="row g-3">
                              {[
                                ...
                                const val = categoryForm.perilakuBerisikoDewasa?.[key] || "";
                                return (
