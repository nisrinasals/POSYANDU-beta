      ...
      globalSasaranList.forEach(s => {
        ...
        if (isReferred) {
          ...
          list.push({
            ...
            masalahSub: l5?.topikPenyuluhan || 'Ditemukan indikasi risiko/klinis dari posyandu yang memerlukan evaluasi lanjutan.',
            tglDirujuk: exam?.tglPemeriksaan || exam?.tanggal || '20-09-2026',
            kehadiran: 'Hadir',
            catatanKunjungan: ''
          });
        }
